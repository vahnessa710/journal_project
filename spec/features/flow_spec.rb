...
RSpec.feature "Journal App Flow" do
  scenario "User signs up, creates a category, adds a task for that category and deletes the task; User adds a task AGAIN to the same category and checks if it is rendered on Tasks for Today Section, logs out and signs back in" do
    #################################################################################
